/**
 * PrintParts Hub — Vercel Serverless Backend
 * ==========================================
 * This handler exports the Express app for Vercel serverless functions
 */
...
const MONGO_URI = process.env.MONGO_URI || process.env.MONGODB_URI || "mongodb+srv://saiteja:saiteja@cluster0.xwqsnmf.mongodb.net/printparts";
...
// ── Multer Storage (in /tmp for serverless) ────────────────────────────────────
